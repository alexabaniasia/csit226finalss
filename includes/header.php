      ...
      <div class="nav-auth">
        ...
        <?php else: ?>
            <div class="nav-auth-user">
              ...
              <a href="profile.php" class="nav-icon-btn" aria-label="Profile">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
              </a>
              
              <a href="logout.php" style="border: 1px solid rgba(255,255,255,0.4); color: white; padding: 6px 14px; border-radius: 8px; text-decoration: none; font-size: 13px; font-weight: 600; margin-left: 8px;">Logout</a>
            </div>
        <?php endif; ?>
      </div>
